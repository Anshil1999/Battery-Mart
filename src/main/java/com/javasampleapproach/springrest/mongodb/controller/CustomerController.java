...
public class CustomerController {
	...
	public Customer postCustomer(@RequestBody Customer customer) {
		...
		Customer _customer = repository.save(new Customer(customer.getSrn(), customer.getDate(), customer.getVrn(), customer.getName(), customer.getPhone()));
		return _customer;
	}
	...
	public List<Customer> findByPhone(@PathVariable String phone) {
